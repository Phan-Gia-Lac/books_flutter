...
class _LoginScreenState extends State<LoginScreen> {
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                shaderCallback: (bounds) =>
                                    const LinearGradient(
                                      ...
                                      colors: [
                                        Color(
                                          0xFFE2E8F0,
                                        ), // Cool platinum silver reflection
                                        Color(
                                          0xFF94A3B8,
                                        ), // Soft chrome shadows
                                        Color(0xFFCBD5E1),
                            ...
                            Container(
                              color: const Color(
                                0xFF151617,
                              ), // Rich, clean premium matte black container base
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      enabledBorder: const OutlineInputBorder(
                                        ...
                                        borderSide: BorderSide(
                                          color: Color(
                                            0xFF2E3135,
                                          ), // Smooth custom charcoal wire frame
                                          width: 1.5,
                                        ),
                                      ),
  ...
  Widget _buildSocialCircle(IconData icon, Color bg, {bool isGoogle = false}) {
    return Container(
      ...
      child: Center(
        child: Icon(icon, color: bg, size: isGoogle ? 32 : 24),
      ),
    );
  }
}
